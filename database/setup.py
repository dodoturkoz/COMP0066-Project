    ...
    def __setup_tables(self):
        ...
        self.cursor.execute(f"""
            CREATE TABLE IF NOT EXISTS Appointments (
                ...
                clinician_id INTEGER,
                date DATETIME NOT NULL,
                status TEXT NOT NULL CHECK( status IN {appointment_statuses} ),
                patient_notes TEXT,
        ...
        if len(users.fetchall()) == 0:
            ...
            appointments = [
                ...
                (
                    ...
                    2,
                    5,
                    datetime(2024, 11, 26, hour=16, minute=0),
                    "Did Not Attend",
                ...
                (
                    ...
                    2,
                    5,
                    datetime(2024, 12, 4, hour=16, minute=0),
                    "Cancelled By Clinician",
                    "notes about condition",
                    None,
                ),
                (
                    ...
                    3,
                    5,
                    datetime(2024, 12, 3, hour=16, minute=0),
                    "Did Not Attend",
                    "notes about condition",
                    None,
                ),
                (
                    ...
                    3,
                    5,
                    datetime(2024, 12, 15, hour=16, minute=0),
                    "Cancelled By Patient",
                    "notes about condition",
                    None,
                ),
